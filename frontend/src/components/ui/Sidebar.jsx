          ...
          {filteredData.length > 0 ? (
            filteredData.map((item, idx) => (
              ...
              >
                ...
                {/* NEW: show MW if potensi */}
                {dataMode === "potensi" && (
                  <div className="mt-2 text-[10px] text-cyan-300 font-semibold">
                    Prediksi: {item.prediksi_mw} MW
                  </div>
                )}
              </div>
            ))
            ...
            <div className="h-full flex flex-col items-center justify-center text-slate-600 py-20 animate-pulse">
              ...
              <p className="text-[10px] mt-1 text-slate-700 text-center px-4">
